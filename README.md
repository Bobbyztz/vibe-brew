...
```bash
# 推荐：pipx 安装（隔离环境，不污染系统 Python）
pipx install git+https://github.com/johnlui/vibe-brew.git

# 或用 uv
uv tool install git+https://github.com/johnlui/vibe-brew.git
```
...
```bash
git clone https://github.com/johnlui/vibe-brew.git
cd vibe-brew
